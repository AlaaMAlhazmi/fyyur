...
class Artist(db.Model):
    ...
    def __repr__(self):
        return f'< id: {self.id}, name: {self.name}, state: {self.state}, phone: {self.phone}, image_link: {self.image_link}, facebook_link: {self.facebook_link}, image_link: {self.image_link}, genres: {self.genres}, website: {self.website}, seeking_venue: {self.seeking_venue}, seeking_description: {self.seeking_description}>'
